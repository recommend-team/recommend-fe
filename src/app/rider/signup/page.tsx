...
const tiers: Tier[] = [
  {
    ...
    title: "Solo rider",
    blurb:
      "Register as an individual. Full KYC keeps your account — and your customers — safe.",
    requirements: [
      "Name, phone, email",
  ...
  },
  {
    ...
    title: "Fleet / company",
    blurb:
      "Register your logistics business and manage multiple riders under one account.",
    requirements: [
      "Company name, CAC & TIN",
      "Office address & contact person",
      "Business bank account",
      "Roster of riders with vehicle info",
    ],
  },
];

export default function RiderSignupTierSelectionPage() {
  return (
    <BackgroundTwo>
        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-8">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <Text variant="neighborhoods-list" color="grey" className="max-w-xl">
              Pick the option that fits. You can always change your plan later.
            </Text>
          </div>
